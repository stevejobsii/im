...
return [
    ...
    'Weibo Username example: PHPHub' => '如：XXXXXX',
    ...
    'Operation succeeded.' => '操作成功!^_^',
    'Login Successfully.' => '成功登录!^_^',
    'Congratulations and Welcome!' => '恭喜，您已经成功加入 XXXXXX!^_^',
    ...
    'Setup multiple Bindings allow you to login to the same account with different binding site account.' => '绑定多个第三方账号，允许你使用任意一个第三方账号登录同一个 XXX 账号。',

    'Photo Upload' => '上传头像',
    'Selected image:' => '请选择图片：',
    'Uploading image...' => '图片上传中...',
    'Update Avatar Success' => '成功上传头像!^_^',
